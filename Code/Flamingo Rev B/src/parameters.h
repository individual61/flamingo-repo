...
// Sparkle Fizz
#define MAX_G_SPARKLEFIZZ 2.0f // acceleration in m/sˆ2 for max sparkle
...
#define ACC_MAX_DECAY_RATE 4000.0f // A0 * exp( - t/AVG_DECAY_RATE), in ms, sets decay rate of acceleration max
